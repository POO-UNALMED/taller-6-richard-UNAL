...
public class TestFuncionalidades {
	...
	static {
		...
		new Camion("SS", "vehiculo.Camion premium", 1000, 100, f1, 3);
		new Camion("AA", "vehiculo.Camion", 1000, 100, f1, 3);
		...
		new Camion("SS", "vehiculo.Camion premium", 1000, 100, f3, 3);
		new Camion("AA", "vehiculo.Camion", 1000, 100, f3, 3);
